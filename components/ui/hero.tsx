...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(60%_60%_at_70%_10%,rgba(99,102,241,0.18),transparent_55%),radial-gradient(50%_50%_at_20%_30%,rgba(236,72,153,0.16),transparent_55%)]" />
