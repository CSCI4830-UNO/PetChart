            ...
            <header className="sticky top-0 z-40 border-b border-gray-200/70 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
                <div className="max-w-4xl mx-auto px-6 lg:px-8">
                    <div className="flex items-start justify-between py-6">
                        <div>
                            <h1 className="text-3xl lg:text-4xl font-semibold tracking-tight text-gray-900">Vaccination History</h1>
                            <p className="text-sm text-gray-600 mt-1">View and manage vaccinations for {pet.name}</p>
                        </div>
                        <button
                            onClick={() => router.back()}
